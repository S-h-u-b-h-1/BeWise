    ...
    <div className="budget-page">
      ...
      <section className="saving-category">
        ...
        <ul>
          ...
          <li>Look for deals on Airbnb or vacation rentals, especially for longer stays.</li>
      ...
      <section className="saving-category">
        ...
        <ul>
          ...
          <a href="https://www.kayak.co.in/cars/" target="_blank" rel="noopener noreferrer">
              <button className="book-button">Compare Car Rentals and Flights on Kayak 🔗 </button>
            </a>
        </ul>
      </section>
